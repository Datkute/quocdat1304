        ...
        <main id="main">
            <div class="container">
                ...
                <h1 class="primary__title">
                    <a href="index.php"> CÁC SẢN PHẨM MỚI NHẤT</a>           
                </h1>
                <h1 class="primary__title">
                    &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
                </h1>
                <h1 class="primary__title">
                    <a href="PhuKien.php">PHỤ KIỆN ĐIỆN THOẠI</a>
                </h1>
            ...
            <section class="section newsletter" id="contact">
                <div class="container">
                    <div class="newsletter__content">
                        ...
                        <?php
                            $sql_sb = "SELECT * FROM Mail-sb";
                            $query_sb = mysqli_query($conn, $sql_sb);
                            echo"    
                                <form action='TB_KQDK.php' mothod='POST'>
                                    <input type='email' placeholder='Enter your email address' class='newsletter__email'>
                                    <a class='newsletter__link' href='TB_KQDK.php'>subscribe</a>
                                </form>
                            ";
                        ?>
                    </div>
